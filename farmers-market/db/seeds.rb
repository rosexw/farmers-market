...
farmer303 = Farmer.create({
  ...
  password_digest: BCrypt::Password.create('easy'),
  description: 'Our cider is award winning and is the best in Niagara! We work hard all season ensuring our fruit is not only juicy and delicious, but also sustainable. We strive to keep our operation sustainable and good for all of our customers.',
  first_name: 'Thomas',
  last_name: 'Warner',
  phone_no: 9055625637,
